...
import com.porfoliodrg.drg.Dto.dtoEducacion;
import com.porfoliodrg.drg.Entity.Educacion;
import com.porfoliodrg.drg.Security.Controller.Mensaje;
import com.porfoliodrg.drg.Service.SEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id) {
        ...
        return new ResponseEntity(new Mensaje("Educacion quitada"), HttpStatus.OK);
    }
